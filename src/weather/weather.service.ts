...
export class WeatherService {
    ...
    async getInfoByNames(cityCountryName: CityNamesDto, req: Request) {
    ...
    async forecastData(query: GeoCodesDto) {
        ...
        const apiUrl = `https://api.weatherapi.com/v1/forecast.json?key=${process.env.WEATHER_API_KEY}&q=${coordinates}&dt=${date}`
        console.log(apiUrl);
