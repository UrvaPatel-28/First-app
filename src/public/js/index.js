...
async function weatherInfoByNames(e) {
    ...
    const url = `http://localhost:3000/weather/by-names?city=${city}&country=${country}`;
...
async function getDataByCode(lat, long, date) {
    const url = `http://localhost:3000/weather/forecast?latitude=${lat}&longitude=${long}&date=${date}`;
